...
<html>
    <head>
        ...
        <SCRIPT>
            ...
            $('#' + tableID + '').append('<tr><td align="left" valign="top"><INPUT type="checkbox" name="chk"/><input type="hidden" name="labour_type" value="service" /><input type="hidden" name="serviceid" value="" id="serviceid"/><input type="hidden" name="serviceAction" class="serviceAction"/></td><td align="left" valign="top"><input name="servicename" type="text" id="labour" /></td><td align="left" valign="top"><textarea name="labourdescription" class="labourdescription" id="textfield2"></textarea></td><td align="left" valign="top"><input name="servicetotal" value="0" type="number" step="0.01" onchange="laborcall()" class="charges" /></td></tr>');
            }
            }
                ...
                <form action="insertestimate" method="post">
                    ...
                    <TABLE id="dataTable1" border="0" class="CSSTableGenerator">
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top"><input name="servicetotal" value="0" type="number" step="0.01" class="charges" onchange="laborcall()" /></td>
                        </tr>
                    </TABLE>
