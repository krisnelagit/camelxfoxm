...
<html>
    ...
    <body><a href="CreateConsumableCarParts" class="view">Create</a>
        <h2>Vehicle list</h2>
        <br />
            ...
            <tbody>
                ...
                <c:forEach var="ob" items="${sparesVehicleDetails}">
                    <tr>
                        ...
                        <td align="left"> 
                            <a href="viewGenericSparesList?id=${ob.branddetailid}"><img src="images/Enter_Left.png" width="16" height="17" /></a>                        
                        </td>
                    </tr>
