        ...
        <script>
            ...
            function addRow(tableID) {
                ...
                if (tableID === "dataTable") {
                    $('#' + tableID + '').append('<tr><td align="left" valign="top"><INPUT type="checkbox" name="chk"/><input type="hidden" name="partid" value="" id="prdid"/></td><td align="left" valign="top"><input name="carparts" type="text" id="carparts" /></td><td align="left" valign="top"><select name="manufacturerid" class="manufacturer" style="width: 100px" onchange="iambatman(this)"><option>--select--</option><option></option></select></td><td align="left" valign="top"><input name="partQuantity" type="text" class="quantity" style="width: 60px" value="0" onchange="calculatebalance(this)" /></td><td align="left" valign="top"><input name="sellingprice" type="text" onchange="calculateselling(this)" class="sellingprice" value="0" style="width: 50px"/></td><td align="left" valign="top" class="inventoryinsurance"><input name="insurancepercent" min="0" max="100" step="0.01" value="' + insurance_percent + '" type="number" class="insurancepercent" onchange="calculateinsurance(this)" style="width: 70px" /></td><td align="left" valign="top" class="inventorycompanyinsurance"><input name="insurancecompanyamount" readonly="" type="text" value="0" class="insurancers" style="width: 100px"/></td><td align="left" valign="top" class="inventorycustinsurance"><input name="insurancecustomeramount" readonly="" type="text" value="0" class="custinsurance" style="width: 100px"/></td><td align="left" valign="top"><input name="itemtotal" readonly="" type="text" value="0" class="itemtotal" style="width: 100px"/></td></tr>');
                } else {
                    $('#' + tableID + '').append('<tr><td align="left" valign="top"><INPUT type="checkbox" class="serviceloopcount" name="chk"/><input type="hidden" name="serviceid" value="" id="serviceid"/></td><td align="left" valign="top"><input name="servicename" type="text" onchange="copyfield(this)" id="labour" /></td><td align="left" valign="top"><input type="hidden" class="serviceAction" name="serviceAction" value="" /></td><td align="left" valign="top"><input name="description" type="text" class="description" /></td>                <td align="left" valign="top" class="labourinsurance"><input name="serviceinsurancepercent" type="text" value="' + insurance_percent + '" class="insurancepercent"  min="0" max="100" step="0.01" onchange="calculateInsurancebalance(this)" style="width: 70px"/></td><td align="left" valign="top" class="labourcompanyinsurance"><input name="companyinsuranceservice" type="text" readonly="" value="0" class="insuranceServicers" style="width: 100px"/></td><td align="left" valign="top" class="labourcustinsurance"><input name="custinsuranceservice" type="text" readonly="" value="0" class="insuranceServicerscustomer" style="width: 100px"/></td><td align="left" valign="top"><input name="servicetotal" onchange="calculateLabourbalance()" value="0" style="width: 100px" type="text" class="charges" /></td></tr>');
                }
            ...
            <form action="convertinInvoice" method="POST">
                ...
                <TABLE id="dataTable1" border="0" class="CSSTableGenerator">
                    ...
                    <c:forEach var="obb" items="${userpartdtls}">
                        <tr>
                            ...
                            <td align="left" valign="top" class="labourinsurance"><input name="serviceinsurancepercent" type="number" value="0"  min="0" max="100" step="0.01" class="insurancepercent" onchange="calculateInsurancebalance(this)" style="width: 70px"/></td>
                    ...
                    <c:if test="${not empty userservicedtls}">
                        <c:forEach var="obb" items="${userservicedtls}">
                            <tr>
                                ...
                                <td align="left" valign="top" class="labourinsurance"><input name="serviceinsurancepercent" type="number"  min="0" max="100" value="0" step="0.01" class="insurancepercent" onchange="calculateInsurancebalance(this)" style="width: 70px"/></td>
                                <td align="left" valign="top" class="labourcompanyinsurance"><input name="companyinsuranceservice" type="text" readonly="" value="0" class="insuranceServicers" style="width: 100px"/></td>
                                <td align="left" valign="top" class="labourcustinsurance"><input name="custinsuranceservice" type="text" readonly="" value="0" class="insuranceServicerscustomer" style="width: 100px"/></td>
                ...
                <TABLE id="claimss">
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <input name="claimcharges"  min="0" max="100" value="0" step="0.01" type="number" id="claimcharges" />
                        </td>                
                    </tr>
                    <tr>
                        <td width="45%" align="left">
