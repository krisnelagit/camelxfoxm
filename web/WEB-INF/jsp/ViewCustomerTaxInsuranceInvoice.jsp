...
//                }, margins);
    ...
    <body>
        ...
        <a href="${param.invoiceid}" onclick="" class="view button-001 paymenthistory"><img src="images/wallet33.png" width="15" height="13"/>&nbsp;History</a>  <a href="sendMailTaxInvoice?invoiceid=${param.invoiceid}" class="view button-001">Goto Send Mail</a>  <a href="viewCustomerInsuranceInvoice?invoiceid=${param.invoiceid}" class="view button-001">Back</a><a href="#" class="view button-001" onclick="printContent('printdiv')">Print</a>
