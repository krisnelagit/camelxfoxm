...
<html>
    ...
    <body>
        ...
        <br />
        <form action="addReminderCustomer" method="POST">        
            ...
            <table width="100%" cellpadding="5">
                ...
                <tr>
                    ...
                    <td width="66%" align="left" valign="top"><textarea name="message" id="message"></textarea></td>
                </tr>
                <tr>
                    <td width="34%" align="left" valign="top">Date & time</td>
                    <td width="66%" align="left" valign="top"><input name="date_time" id="apdatetimepicker" id="textfield2" type="text"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
