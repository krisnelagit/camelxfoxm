        ...
        <SCRIPT language="javascript">
            ...
            function addRow(tableID) {
                ...
                if (tableID === "dataTable") {
                    ...
                    $('#' + tableID + '').append('<tr><td align="left" valign="top"><INPUT type="checkbox" name="chk" value="0"/><input type="hidden" name="newserviceid" value="" id="serviceid"/></td><td align="left" valign="top"><input name="newservicename" type="text" id="labour" /></td><td align="left" valign="top"><input name="newdescription" type="text" class="description" /></td><td align="left" valign="top" class="labourinsurance"><input name="newserviceinsurancepercent" value="' + insurance_percent + '" type="text" class="insurancepercent"  min="0" max="100" step="0.01" onchange="calculateInsurancebalance(this)" style="width: 100px"/></td><td align="left" valign="top" class="labourcompanyinsurance"><input name="newcompanyinsuranceservice" type="text" readonly="" value="0" class="insuranceServicers" style="width: 100px"/></td><td align="left" valign="top" class="labourcustinsurance"><input name="newcustinsuranceservice" type="text" readonly="" value="0" class="insuranceServicerscustomer" style="width: 100px"/></td><td align="left" valign="top"><input name="newservicetotal" onchange="calservicetotal();" value="0" type="text" class="charges" /></td></tr>');
                }
            ...
            <TABLE id="dataTable1" border="0" class="CSSTableGenerator">
                ...
                <c:forEach var="labob" items="${labourinventorydt}">                
                    <tr>
                        ...
                        <td align="left" valign="top" class="labourinsurance"><input name="serviceinsurancepercent"  min="0" max="100" step="0.01" type="text" class="insurancepercent laborpercent" value="${labob.serviceinsurancepercent}" onchange="calculateInsurancebalance(this)" style="width: 100px"/></td>
