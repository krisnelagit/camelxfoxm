...
<html>
    ...
    <body>
        ...
        <br>
        <c:choose>
            <c:when test="${invoicedtls.fbstatus=='complete'}">
                <h2>This feedback is already been taken</h2>
            </c:when>
        </c:choose>
        <h2>Questionnaire</h2>
        <br>
        <form action="insertFeedback" id="questionaire" method="POST">
            ...
            <table cellpadding="5" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td align="left" valign="top" colspan="2" ><textarea name="question6" maxlength="600" id="textarea" rows="8" cols="90">
                            </textarea><div id="textarea_feedback"></div></td>
                    </tr>
                    <tr>
